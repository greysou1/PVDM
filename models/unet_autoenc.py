...
class BeatGANsAutoencModel(BeatGANsUNetModel):
    ...
    def forward(self,
        ...
        # print("# x: the original image to encode")
        # print(f"# x = torch.cat([xt, target_pose],1)")
        # print(f"{x.shape = }")
        # print("# t: timestep")
        # print("# t = (torch.ones(n) * i).to(x.device) | n = x.size(0); for i, j in tqdm.tqdm(zip(reversed(seq), reversed(seq_next)))")
        # print(f"{t = }")
        # print(f"# cond: source image")
        # print(f"{len(cond) = }")
        # print(f"{cond[0].shape = }")
        # print("noise: random noise (to predict the cond)")
